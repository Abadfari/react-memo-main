...
- Три ошибки - игрок может ошибиться 3 раза
...
- Если карточки не совпадают ⇒ игра заканчивается(кроме уровня "Три ошибки")
- Если был выбран режим "Три ошибки" и карточки не совпадают ⇒ игра продолжается, игрок теряет 1 жизнь
  -Если жизни закончились- игра заканчивается
